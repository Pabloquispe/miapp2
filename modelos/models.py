...
class Usuario(db.Model):
    ...
    comentarios_servicio = db.relationship('ComentarioServicio', backref='usuario', lazy=True)
    registros_usuario = db.relationship('RegistroUsuario', backref='usuario', lazy=True)
